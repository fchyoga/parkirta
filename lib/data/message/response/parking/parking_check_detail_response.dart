...
ParkingCheckDetailResponse parkingCheckDetailResponseFromJson(String str) =>
    ParkingCheckDetailResponse.fromJson(json.decode(str));

String parkingCheckDetailResponseToJson(ParkingCheckDetailResponse data) =>
...
class ParkingCheckDetailResponse {
  ...
  factory ParkingCheckDetailResponse.fromJson(Map<String, dynamic> json) =>
      ParkingCheckDetailResponse(
        success: json["success"],
        data: json["data"] != null
            ? ParkingCheckDetail.fromJson(json["data"])
            : null,
...
class ParkingCheckDetail {
  ...
  factory ParkingCheckDetail.fromJson(Map<String, dynamic> json) =>
      ParkingCheckDetail(
