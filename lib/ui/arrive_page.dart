...
class _ArrivePageState extends State<ArrivePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
        create: (context) =>
            ParkingBloc()..checkDetailParking(retributionId.toString()),
        child: BlocListener<ParkingBloc, ParkingState>(listener:
          ...
          return Scaffold(
                ...
                title: Padding(
                  ...
                  child: Column(
                    children: [
                      Text(
                        parkingCheckDetail
                                ?.retribusi.lokasiParkir?.namaLokasi ??
                            "",
                        maxLines: 2,
                      ...
                      Text(
                        parkingCheckDetail
                                ?.retribusi.lokasiParkir?.alamatLokasi ??
                            "",
                        maxLines: 2,
                        textAlign: TextAlign.center,
                        style: const TextStyle(
                ...
                actions: [
                  IconButton(
                    onPressed: () {
                      ...
                      context
                          .read<ParkingBloc>()
                          .checkDetailParking(retributionId.toString());
                    },
              ...
              body: Stack(
                ...
                children: [
                  parkingCheckDetail?.retribusi.lat != null
                      ? GoogleMap(
        ...
        return AlertDialog(
          ...
          actions: [
            TextButton(
              ...
              onPressed: () {
                Navigator.of(context).pop();
                _context.read<ParkingBloc>().cancelParking(
                    (parkingCheckDetail?.retribusi.lokasiParkir?.id ?? 0)
                        .toString());
              },
            ),
            TextButton(
